# 基于C#Winform与WPF的Project
BL12 : 基于一组背光LED板所开发的上位机检测软件,还附有数据上传MES功能.
...
Danikor : 基于丹尼克尔螺丝机开发的上位机软件,主要是设置螺丝机参数与操作流程数据上传MES系统
...
MachineVision : 基于WPF的Halcon二次开发，主要为文字缺陷检测的处理
...
ASIL : 基于屏幕背光板的电压读取上位机,主要配和厂方的检测机做操作,可当中一个中间件与MES系统的数据交互
...
![image](https://github.com/user-attachments/assets/10c4478f-dd7d-44e4-819d-45a6d413834b)
Color Sensor ：基于一款屏幕亮度检测所开发的上位机软件，主要检测屏幕亮度是否在所在区间否则进行警报
<img width="1381" height="806" alt="image" src="https://github.com/user-attachments/assets/19676bd5-7eef-49f2-83b8-ffa57bf088c5" />
<img width="1381" height="803" alt="image" src="https://github.com/user-attachments/assets/7cc9a4b5-56ed-45cd-8d06-26e2f4875495" />
MyToDo : 基于WPF的记事本功能 学习为主
